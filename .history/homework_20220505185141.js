...
var fs = require('fs')
var readfile = fs.readFileSync("score.json")
var translated_file = JSON.parse(readfile)

if (translated_file.score > count){
    var jsonscore = {
        score:count
    }
    var translated_score = JSON.stringify(jsonscore, null, 1)
    fs.writeFileSync("score.json", translated_score)
}
